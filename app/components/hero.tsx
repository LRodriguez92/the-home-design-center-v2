    ...
    <div className="relative h-[calc(100vh-4rem)] flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          ...
          <p className="mx-auto max-w-2xl text-xl sm:text-2xl text-gray-200">
            {subtitle}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href={`/${currentLang}/contact`}
              className="inline-flex items-center px-8 py-3 rounded-md bg-primary text-[#0F0F0F] text-lg font-semibold hover:bg-primary/90 transition duration-300"
            >
              {t('home.hero.buttons.contact')}
            </Link>
            <Link 
              href={`/${currentLang}/projects`}
              className="inline-flex items-center px-8 py-3 rounded-md border-2 border-secondary bg-transparent text-white text-lg font-semibold hover:bg-secondary/10 transition duration-300"
            >
